...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name multicluster-provider-kubebuilder-example-builder
	$(CONTAINER_TOOL) buildx use multicluster-provider-kubebuilder-example-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm multicluster-provider-kubebuilder-example-builder
	rm Dockerfile.cross
